...
CameraGL::CameraGL() : 
   CameraGL(vec3(90.0f, 50.0f, 90.0f), vec3(0.0f, 0.0f, 0.0f), vec3(0.0f, 1.0f, 0.0f))
{   
}
...
CameraGL::CameraGL(
   ...
   ZoomSensitivity( 1.0f ), MoveSensitivity( 0.5f ), RotationSensitivity( 0.005f ), IsMoving( false ),
