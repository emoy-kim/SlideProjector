...
public:
   ...
   void reallocateTexture(const cv::Mat& texture, int index);
   void updateTexture(const cv::Mat& texture, int index) const;
...
private:
   ...
   void prepareTexture2DFromMat(const cv::Mat& texture) const;
